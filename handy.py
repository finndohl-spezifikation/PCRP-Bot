...
def _build_handy_embed() -> discord.Embed:
    embed = discord.Embed(
        ...
        description=(
            ...
            "**📱 SIM Karte Wechseln** — Neue Nummer generieren & öffentlich ankündigen\n"
            "**📱 Handy Einschalten / Aus** — Erreichbarkeit steuern\n"

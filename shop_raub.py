...
SHOP_RAUB_CONFIRM_ROLES = {ADMIN_ROLE_ID, MOD_ROLE_ID, DASH_ROLE_ID}
...
def build_shop_raub_info_embed() -> discord.Embed:
    embed = discord.Embed(
        ...
        description=(
            ...
            "**\u23F1\uFE0F Dauer:** **15 Minuten**\n"
            "**\U0001F4B0 Beute:** zwischen **12.000 $** und **22.000 $** *(zuf\u00E4llig)*"
        ),
        color=LOG_COLOR,
...
def _build_beweis_embed(user: discord.Member, bild_url: str) -> discord.Embed:
    ...
    embed.set_footer(text="Paradise City Roleplay \u2022 Shop-Raub System | Best\u00E4tigung: Highteam")
    return embed

...
SB_IMAGE_URL = "https://4dc1d74d-ea8e-46f4-b123-1e1a11f5dfed-00-c2y924gtit5c.worf.replit.dev/api/files/staatsbank.jpg"
...
def _build_result_embed(
    ...
    if success:
        ...
        color = 0xE74C3C
        title = "🏦 Staatsbank — Fehlgeschlagen ❌"
...
class StaatsbankView(discord.ui.View):
    ...
    for uid_str in on_duty_lapd:
        try:
            ...
            cop_embed = discord.Embed(
                title="🚔 LAPD — Staatsbank-Raub gemeldet!",

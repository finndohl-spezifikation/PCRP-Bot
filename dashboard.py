...
def _call_async(coro):
    # Bot-Loop nutzen wenn verfÃ¼gbar (discord.py lÃ¤uft darin)
    if _bot_ref and hasattr(_bot_ref, 'loop') and _bot_ref.loop and _bot_ref.loop.is_running():
...
# â”€â”€ Datei-Download (kein Login nÃ¶tig) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
import os as _os
...
# â”€â”€ API: Economy â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_economy_edit(uid):
    ...
    name  = _name(uid)
    log_activity("GELD", f"{name} ({uid}): {label} {old:,}$ â†’ {value:,}$ (Dashboard)")
    return jsonify({"ok": True})


# â”€â”€ API: Warns â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_warn_add(uid):
    ...
    log_activity(session.get("discord_name","?"), f"Warn hinzugefÃ¼gt fÃ¼r {uid}: {grund}")
...
def api_warn_delete(uid, idx):
    ...
    if idx < 0 or idx >= len(warns):
        return jsonify({"error": "Index ungÃ¼ltig"}), 400
...
def api_team_warn_add(uid):
    ...
    log_activity(session.get("discord_name","?"), f"Team-Warn hinzugefÃ¼gt fÃ¼r {uid}: {grund}")
    return jsonify({"ok": True, "count": len(data[uid])})
...
# â”€â”€ API: Inventories â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_inventory_add(uid):
    ...
    with _lock:
        ...
        _write_json(ECONOMY_FILE, eco)
    from dashboard_hooks import log_activity
    log_activity("ITEM", f"Item '{item}' zu {_name(uid)} ({uid}) hinzugefÃ¼gt ({field})")
    return jsonify({"ok": True})
...
def api_inventory_remove(uid, itype, idx):
    ...
    with _lock:
        ...
        if idx < 0 or idx >= len(items):
            return jsonify({"error": "Index auÃŸerhalb"}), 400
...
# â”€â”€ API: Shops â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

_SHOP_KEYS = ("kwik", "baumarkt", "schwarzmarkt")

def _shops_as_dict():
    """Liest shop_data.json (Liste) und gruppiert nach shop-SchlÃ¼ssel."""
...
def api_add_shop_item():
    ...
    with _lock:
        raw = _read_json(SHOP_FILE, [])
        if isinstance(raw, dict):
            # altes Dict-Format â€” konvertieren
            items_list = []
    ...
    from dashboard_hooks import log_activity
    log_activity("SHOP", f"Item '{full_name}' ({preis}$) zu Shop '{shop}' hinzugefÃ¼gt")
    return jsonify({"ok": True})
...
# â”€â”€ API: Bans â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Team-Shop API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
@app.route("/api/team-shop-items", methods=["GET"])
@api_login_required
def api_team_shop_get():
    from economy_helpers import load_team_shop
    return jsonify(load_team_shop())


@app.route("/api/team-shop-items", methods=["POST"])
@api_login_required
def api_team_shop_add():
    from economy_helpers import load_team_shop, save_team_shop
    body = request.get_json(force=True) or {}
    name = body.get("name", "").strip()
    if not name:
...
@app.route("/api/team-shop-items/<int:idx>", methods=["PATCH"])
@api_login_required
def api_team_shop_edit(idx):
    from economy_helpers import load_team_shop, save_team_shop
    body = request.get_json(force=True) or {}
    name = body.get("name", "").strip()
    if not name:
    ...
    with _lock:
        items = load_team_shop()
        if idx < 0 or idx >= len(items):
            return jsonify({"error": "Index ung\u00FCltig"}), 404
        items[idx]["name"] = name
        save_team_shop(items)
    return jsonify({"ok": True})


@app.route("/api/team-shop-items/<int:idx>", methods=["DELETE"])
@api_login_required
def api_team_shop_delete(idx):
    from economy_helpers import load_team_shop, save_team_shop
    with _lock:
        items = load_team_shop()
        if idx < 0 or idx >= len(items):
...
# â”€â”€ API: Blacklist â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def api_blacklist_add():
    ...
    from dashboard_hooks import log_activity
    log_activity("BLACKLIST", f"'{name}' ({uid}) zur Blacklist hinzugefÃ¼gt")
    return jsonify({"ok": True})
...
# â”€â”€ API: Logs / Warnings â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ API: Members & Players â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ API: Invites â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ API: Notes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ API: Status â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ API: Tickets â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ API: Guild-Channels â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
@app.route("/api/guild-channels/<int:ch_id>/move", methods=["POST"])
@api_login_required
def api_guild_channel_move(ch_id):
    if not _bot_ref:
        return jsonify({"error": "Bot nicht verbunden"}), 503
    body      = request.get_json(force=True) or {}
    direction = body.get("direction", "")  # 'up' oder 'down'
    new_pos   = body.get("position")         # oder direkte Position
    ...
    async def _move():
        ...
        try:
            ...
            if direction == 'up':
                ...
                return {"error": "Keine Richtung angegeben"}
            await ch.edit(position=target)
            return {"ok": True, "position": ch.position}
        except Exception as e:
            return {"error": str(e)}

    result = _call_async(_move())
    if result.get("error"):
        return jsonify(result), 500
    log_activity(session.get("discord_name", "?"), f"Kanal {ch_id} verschoben ({direction or new_pos})")
    return jsonify(result)
...
# â”€â”€ Editor.js route â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

@app.route("/editor.js")
def serve_editor_js():
    from flask import Response
    try:
        from editor_js import EDITOR_JS
        js = EDITOR_JS
    except Exception:
        js = "/* editor_js.py not found */"
    return Response(js, mimetype="application/javascript")


# â”€â”€ Editor: Embed/Button/Command Configs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€

_EMBED_CONFIGS_FILE  = DATA_DIR / "embed_configs.json"
_BUTTON_CONFIGS_FILE = DATA_DIR / "button_configs.json"
...
@app.route("/api/embed-configs")
@api_login_required
def api_embed_configs():
    stored = _read_json(_EMBED_CONFIGS_FILE, {})
    result = {}
    for key, defaults in _EMBED_DEFAULTS.items():
...
@app.route("/api/embed-configs/<key>", methods=["PATCH"])
@api_login_required
def api_embed_config_save(key):
    if key not in _EMBED_DEFAULTS:
        return jsonify({"error": "Unbekannter Embed-Key"}), 400
    body = request.get_json(force=True) or {}
    with _lock:
        stored = _read_json(_EMBED_CONFIGS_FILE, {})
        entry  = stored.setdefault(key, {})
        if "title" in body:
            entry["title"]       = str(body["title"])[:256]
        if "description" in body:
            entry["description"] = str(body["description"]) if body["description"] else None
        if "footer" in body:
            entry["footer"]      = str(body["footer"])[:2048]
        if "color" in body:
            try:
                entry["color"] = int(str(body["color"]).replace("#", ""), 16)
            except Exception:
                pass
        _write_json(_EMBED_CONFIGS_FILE, stored)
    from dashboard_hooks import log_activity as _la
    _la(session.get("discord_name", "?"), f"Embed-Config '{key}' gespeichert")
    return jsonify({"ok": True})


@app.route("/api/embed-configs/<key>/refresh", methods=["POST"])
@api_login_required
def api_embed_config_refresh(key):
    if not _bot_ref:
        return jsonify({"error": "Bot nicht verbunden"}), 503
    ...
    async def _do():
        try:
            if key == "weed":
                import weed as _w
                return await _w._weed_setup()
            elif key == "kokain":
                import kokain as _k
                return await _k._koka_setup()
            return "\u274C Unbekannter Key"
        except Exception as exc:
            return f"\u274C Fehler: {exc}"

    result = _call_async(_do())
    from dashboard_hooks import log_activity as _la
    _la(session.get("discord_name", "?"), f"Embed '{key}' in Discord aktualisiert: {result}")
    return jsonify({"ok": True, "message": str(result)})


@app.route("/api/button-configs")
@api_login_required
def api_button_configs():
    stored = _read_json(_BUTTON_CONFIGS_FILE, {})
    result = {}
    for key, defaults in _BUTTON_DEFAULTS.items():
        merged = dict(defaults)
        merged.update(stored.get(key) or {})
        result[key] = merged
    return jsonify(result)
...
@app.route("/api/button-configs/<key>", methods=["PATCH"])
@api_login_required
def api_button_config_save(key):
    if key not in _BUTTON_DEFAULTS:
        return jsonify({"error": "Unbekannter Button-Key"}), 400
    body   = request.get_json(force=True) or {}
    ...
    with _lock:
        ...
        entry  = stored.setdefault(key, {})
        if "label" in body:
            entry["label"] = str(body["label"])[:80]
        if "style" in body and body["style"] in styles:
            entry["style"] = body["style"]
        _write_json(_BUTTON_CONFIGS_FILE, stored)
    from dashboard_hooks import log_activity as _la
    _la(session.get("discord_name", "?"), f"Button-Config '{key}' gespeichert")
    return jsonify({"ok": True})
...
def api_bot_commands():
    ...
    if not _bot_ref:
        return jsonify({"error": "Bot nicht verbunden"}), 503
    try:
        cmds = _bot_ref.tree.get_commands(guild=_discord.Object(id=GUILD_ID))
        result = sorted(
            [{"name": c.name, "description": c.description} for c in cmds],
            key=lambda x: x["name"],
        )
        return jsonify(result)
    except Exception as exc:

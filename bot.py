...
# â”€â”€ Einreise Chat Flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def einreise_chat_flow(channel: discord.TextChannel, member: discord.Member, guild: discord.Guild, einreise_typ: str):
    ...
    felder = [
        ...
        ("nationalitaet", "ðŸ“ **NationalitÃ¤t** â€” Bitte gib deine NationalitÃ¤t ein:"),
        ("wohnort",       "ðŸ“ **Wohnort** â€” Bitte gib deinen Wohnort ein:"),
    ]

    antworten = {}

    start_msg = await channel.send(
        f"{member.mention} ðŸªª **Ausweis-Erstellung gestartet!**\n"
    ...
    for key, frage in felder:
        ...
        try:
            ...
            try:
                ...
                pass
            await channel.send(
                f"{member.mention} âŒ Zeit abgelaufen! Bitte starte den Vorgang erneut.",
                delete_after=10
            )
            return
